...
class EdifyGenerator(object):
  ...
  def LBLperm(self, customstrings):
    ...
    self.script.append('set_metadata("/system/bin/glove_mode_enabled", "uid", 0, "gid", 0, "mode", 0777, "capabilities", 0x0, "selabel", "u:object_r:system_file:s0");')

  def RemoveUselessFiles(self, rmfiles):
    self.script.append('delete("/system/app/Development.apk");')
